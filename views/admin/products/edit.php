            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5 width">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <h3 class="mb-5 font">Edit Products</h3>
                        <hr>
                        <form action="http://<?php echo $_SERVER['HTTP_HOST'] . "/admin/products/" . $product->getId() ?>"
                            ...
                            <div class="form-group">
                                <label class="sr-only font2">Price</label>
                            ...
                            <label class="form-label font2 mt-4">Category</label>
                            ...
                            <div class="form-outline mt-4">
                                <label f class="form-label font2">Product Picture</label>
                                <input class="form-control form-control-lg" id="formFileLg" type="file"
                                       name="featureImage" value="<?php echo $product->getFeatureImage(); ?>"/>
                            </div>

                            <button class="btn btn-lg btn-block button_color mt-4 " type="submit">Edit</button>
                            <button class="btn btn-lg btn-block button_color mt-4 " type="reset">Reset</button>
